...
def compute():
    ...
    for category, paths in tqdm(object_category_paths.items()):
        ...
        for object_path in paths:
            ...
            mask_path = os.path.join('/media/ian/WD/PythonProject/DP-Net/acm-mm-2019-ACO-master/toolboxes/extracted_masks2/masks/', '{}.png'.format(name.split('.')[0]))
    ...
    with open('ratio_annotations2.json', 'w') as fid:
