...
if __name__ == '__main__':
    ...
    parser.add_argument('--images_dir', type=str, default='D:\\datasets\\retail_product_checkout\\train2019')
    ...
    output_dir = 'extracted_masks_origin/masks'
    compare_dir = 'extracted_masks_origin/masked_images'
